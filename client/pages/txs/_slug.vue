                ...
                <b-tabs
                    ...
                    <b-tab
                        ...
                        <div
                            ...
                            class="card defi-card defi-card--transaction">
                            <div class="defi-card__body">
                                <table
                                    v-if="tx"
                                    class="defi-card__table">
                                    <tbody>
                                        <tr>
                                            <td>TxHash</td>
                                            <td>
                                                ...
                                                <small
                                                    ...
                                                    <p
                                                        ...
                                                        <span class="internal-color">
                                                            {{ formatUnit(toDefi(internal.value, 18)) }}</span>
                                        ...
                                        <tr>
                                            <td>Value</td>
                                            <td>{{ formatUnit(toDefi(tx.value, 18)) }}</td>
                                        </tr>
                                        <tr>
                                        ...
                                        <tr>
                                            <td>Gas Price</td>
                                            <td>{{ formatUnit(toDefi(tx.gasPrice, 18)) }}</td>
                                        </tr>
                                        <tr>
                                            <td>Actual Tx Cost/Fee</td>
                                            <td>{{ formatUnit(toDefi(tx.gasPrice * tx.gasUsed, 18)) }}</td>
                                        </tr>
                                                ...
                                                <span class="token-transfer">
                                                    <p
                                                        ...
                                                        <nuxt-link
                                                            ...
                                                            &nbsp;
                                                            <span
                                                                v-if="tokenTx.symbol">TRC21 {{ tokenTx.symbol }}</span>
                                                        </nuxt-link>
                                                    </p>
                                                </span>
                                            </td>
