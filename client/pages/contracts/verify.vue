<template>
    ...
    <section v-else>
        <div class="card defi-card defi-card--verify">
            <div class="defi-card__header">
                <h3 class="defi-card__headline">Verify and Publish your Solidity Source Code</h3>
            ...
            <div class="defi-card__body">
                ...
                <form
                    :class="loadingForm ? 'defi-loading defi-loading--form' : ''"
                    novalidate
