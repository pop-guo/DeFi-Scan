<template>
    ...
    <section v-else>
        <div
            ...
            <p class="defi-empty__description">No masternode found</p>
        </div>

        <p
            v-if="total > 0"
            class="defi-total-items">{{ _nFormatNumber('MasterNode', 'MasterNodes', total) }}</p>
        ...
        <b-table
            ...
            class="defi-table defi-table--masternode"
            stacked="md">
