<template>
    ...
    <section v-else>
        <div class="card defi-card defi-card--address">
            <div class="defi-card__header">
                <h3
                    :class="`defi-card__headline
                    ${(address && address.isContract ? ' defi-card__headline--is-contract' : '')}`">
            ...
            <div class="defi-card__body">
                <table class="defi-card__table">
                    <tbody>
                        ...
                        <tr>
                            <td>DEFI Balance</td>
                            <td>
                                <span>{{ formatUnit(toDefi(address.balance, 18)) }}</span>
                            </td>
                        </tr>
                        <tr>
                            <td>DEFI USD Value</td>
                            <td>
                                <span>{{ formatNumber(usdPrice * toDefiNumber(address.balance)) }}</span>
                            </td>
                        </tr>
                        <tr>
                            <td>Transactions</td>
                ...
                <div class="text-center text-lg-right defi-qrcode">
                    <div>
                        <button
                            v-clipboard="hash"
                            type="button"
...
export default {
    ...
    computed: {
        ...
        codemirror () {
            return [
                this.$refs.defiCmSourceCode.codemirror,
                this.$refs.defiCmAbiCode.codemirror,
                this.$refs.defiCmCode.codemirror
            ]
        },
        hashTab () {
