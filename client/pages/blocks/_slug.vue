<template>
    ...
    <section v-else>
        <div class="card defi-card defi-card--block">
            <div class="defi-card__header">
                <h3
                    v-if="block"
                    class="defi-card__headline">Block
        ...
        <b-tabs
            ...
            <b-tab
                ...
                <div
                    ...
                    <p class="defi-empty__description">No slashed node</p>
                </div>
                <p
                    v-if="block.slashedNode.length > 0"
                    class="defi-total-items">{{ _nFormatNumber('node', 'nodes', block.slashedNode.length) }}</p>
                <table
                    v-if="block.slashedNode.length > 0"
                    class="defi-table">
                    <thead>
